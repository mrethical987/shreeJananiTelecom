...
const Checkout = ({ basketData, orderInfo, orderError, handleCheckout }) => {
  ...
  useEffect(() => {
    const fetchSubdivisions = async (countryCode) => {
      ...
      const FormattedSubdivisions = convertObjectToArray(subdivisions);
      setUser({
        ...user,
        shippingSubdivisions:FormattedSubdivisions,
        shippingSubdivision: FormattedSubdivisions[FormattedSubdivisions.length - 16],
      });
    };
